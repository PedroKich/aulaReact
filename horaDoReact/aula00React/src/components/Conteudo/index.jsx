...
function Conteudo() {
  return (
    <div className='conteudo-container'>
      <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vitae, possimus consectetur quam veritatis, suscipit eum ea praesentium reiciendis quos autem accusantium ipsam omnis totam quae, minima deleniti repellendus. Culpa, nesciunt!</p>
      <img src={'https://www.pokemon.com/static-assets/content-assets/cms2/img/pokedex/full/195.png'} alt="Logo" />
      <img src={'https://shop7.webmodule.prestashop.net/pokedoge/12039-large_default/quagsire.jpg'} width={250} height={250} alt="Logo" />
